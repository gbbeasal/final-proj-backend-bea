...
// replyRouter.get('/tweets', async (request, response) => {
...
// replyRouter.get('/tweets/:userName', async (request, response) => {
//   const cookies = request.cookies;
//   const jwtSession = cookies.sessionId;
...
// replyRouter.delete('/tweets/:tweetId', async (request, response) => {
//   const cookies = request.cookies;
//   const jwtSession = cookies.sessionId;
//   const tweetId = parseInt(request.params.tweetId);
...
// replyRouter.put('/tweets/:tweetId', async (request, response) => {
//   const cookies = request.cookies;
//   const jwtSession = cookies.sessionId;
//   const tweetId = parseInt(request.params.tweetId);
